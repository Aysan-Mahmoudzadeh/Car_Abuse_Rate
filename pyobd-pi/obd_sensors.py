...
def dtc_decrypt(code):
    ...
    if num & 0x80: # is mil light on
        mil = 1
	return "Mil light is ON"
    else:
        mil = 0
	return "Mil light is OFF"
...
SENSORS = [
	...
	Sensor("oil_temp"			   , "Engine Oil Temperature Sensor", "015C" , oil_temp		    ,"F"	  ),
#	Sensor("odometer"              , "Calculate odometer"           , "01A6" , odometer         ,"hm"     ),
#	Sensor("VIN"			       , " 	Vehicle Identification Num" , "0902" , VIN				,"char"   ),
	Sensor("Throttle_posi "        , "Throttle Position G "         , "018D" , Throttle_posi    ,"%"      ),
    ]
