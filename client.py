...
if(os.path.exists('/home/pi/Desktop/Gyro_log/car_*')):
	os.remove(current_directory_Gyro+'/'+files)
else:
	pass


score_content = json.dumps({'OBD': log_data, 'IMU': log_count_point}).encode('utf-8')
#payload = '{"Data_Recorder":"car-24-5-23-4.txt","Score":"'+log_data.encode('utf8').replace("\n","")+'","Time":"2018/2/3 11:2:5"}'
